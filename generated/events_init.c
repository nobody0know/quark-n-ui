...
static void scrHome_event_handler (lv_event_t *e)
{
	...
	{
		ui_scale_animation(guider_ui.scrHome_contBG, 100, 0, 480, 100, &lv_anim_path_ease_out, 0, 0, 0, 0, NULL, NULL, NULL);
...
static void scrHome_contSetup_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrHome_contBG, 200, 0, 480, 272, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrHome_contPrint_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrHome_contBG, 200, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrHome_contCopy_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrHome_contBG, 200, 0, 480, 60, &lv_anim_path_ease_out, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrCopy_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_SCREEN_LOADED:
	{
		ui_scale_animation(guider_ui.scrCopy_contBG, 100, 0, 480, 100, &lv_anim_path_ease_out, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrCopy_btnNext_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		ui_img_zoom_animation(guider_ui.scrCopy_imgScanned, 200, 0, 201, &lv_anim_path_linear, 0, 0, 0, 0, NULL, NULL, NULL);
		...
		ui_scale_animation(guider_ui.scrCopy_contBG, 100, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrCopy2_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_SCREEN_LOADED:
	{
		ui_scale_animation(guider_ui.scrCopy2_contBG, 100, 0, 480, 100, &lv_anim_path_ease_out, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrCopy2_btnBack_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrCopy2_contBG, 100, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrCopy2_btnNext_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrCopy2_contBG, 200, 0, 480, 272, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrScan_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_SCREEN_LOADED:
	{
		ui_scale_animation(guider_ui.scrScan_contBG, 100, 0, 480, 100, &lv_anim_path_ease_out, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrScan_btnNext_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrScan_contBG, 200, 0, 480, 272, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrPrintMenu_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_SCREEN_LOADED:
	{
		ui_scale_animation(guider_ui.scrPrintMenu_contBG, 100, 0, 480, 100, &lv_anim_path_ease_out, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrPrintMenu_btnBack_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrPrintMenu_contBG, 100, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrPrintMenu_contInternet_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrPrintMenu_contBG, 200, 0, 480, 272, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
...
static void scrPrintUSB_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_SCREEN_LOADED:
	{
		ui_scale_animation(guider_ui.scrPrintUSB_contBG, 100, 0, 480, 100, &lv_anim_path_ease_out, 0, 0, 0, 0, NULL, NULL, NULL);
		uint32_t i;
...
static void scrPrintUSB_btnNext_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrPrintUSB_contBG, 200, 0, 480, 272, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrPrintMobile_btnNxet_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrPrintMobile_contBG, 200, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrPrintInternet_btnBack_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrPrintInternet_contBG, 200, 0, 480, 60, &lv_anim_path_linear, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrSetup_btnBack_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		...
		ui_scale_animation(guider_ui.scrSetup_contBG, 200, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrPrintFini_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_SCREEN_UNLOAD_START:
	{
		...
		ui_scale_animation(guider_ui.scrPrintFini_contBG, 200, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
...
static void scrScanFini_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_SCREEN_UNLOAD_START:
	{
		...
		ui_scale_animation(guider_ui.scrScanFini_contBG, 200, 0, 480, 60, &lv_anim_path_ease_in, 0, 0, 0, 0, NULL, NULL, NULL);
		break;
	}
	default:
		break;
