...
void setup_scr_scrPrintMobile(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrPrintMobile, 1024, 600);
	...
	lv_obj_set_size(ui->scrPrintMobile_contBG, 1024, 600);
	...
	lv_img_set_src(ui->scrPrintMobile_imgPrinter, &_printer2_alpha_185x187);
	lv_img_set_pivot(ui->scrPrintMobile_imgPrinter, 55,55);
	lv_img_set_angle(ui->scrPrintMobile_imgPrinter, 0);
	lv_obj_set_pos(ui->scrPrintMobile_imgPrinter, 266, 145);
	lv_obj_set_size(ui->scrPrintMobile_imgPrinter, 185, 187);
	...
	lv_img_set_src(ui->scrPrintMobile_imgWave, &_wave_alpha_44x72);
	lv_img_set_pivot(ui->scrPrintMobile_imgWave, 50,50);
	lv_img_set_angle(ui->scrPrintMobile_imgWave, 0);
	lv_obj_set_pos(ui->scrPrintMobile_imgWave, 492, 205);
	lv_obj_set_size(ui->scrPrintMobile_imgWave, 44, 72);
	...
	lv_img_set_src(ui->scrPrintMobile_imgPhone, &_phone_alpha_117x154);
	lv_img_set_pivot(ui->scrPrintMobile_imgPhone, 50,50);
	lv_img_set_angle(ui->scrPrintMobile_imgPhone, 0);
	lv_obj_set_pos(ui->scrPrintMobile_imgPhone, 580, 165);
	lv_obj_set_size(ui->scrPrintMobile_imgPhone, 117, 154);
	...
	lv_obj_set_pos(ui->scrPrintMobile_labelPrompt, 115, 383);
	lv_obj_set_size(ui->scrPrintMobile_labelPrompt, 793, 70);
	...
	lv_obj_set_style_text_font(ui->scrPrintMobile_labelPrompt, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrPrintMobile_btnNxet, 384, 474);
	lv_obj_set_size(ui->scrPrintMobile_btnNxet, 256, 86);
	...
	lv_obj_set_style_radius(ui->scrPrintMobile_btnNxet, 41, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrPrintMobile_btnNxet, &lv_font_montserratMedium_34, LV_PART_MAIN|LV_STATE_DEFAULT);
