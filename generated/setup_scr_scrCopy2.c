...
void setup_scr_scrCopy2(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrCopy2, 1024, 600);
	...
	lv_obj_set_size(ui->scrCopy2_contBG, 1024, 132);
	...
	lv_obj_set_pos(ui->scrCopy2_btnBack, 53, 37);
	lv_obj_set_size(ui->scrCopy2_btnBack, 74, 70);
	...
	lv_obj_set_style_radius(ui->scrCopy2_btnBack, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_btnBack, &lv_font_montserratMedium_53, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_labelTitle, 288, 50);
	lv_obj_set_size(ui->scrCopy2_labelTitle, 448, 70);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_labelTitle, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrCopy2_imgScanned, &_example_alpha_514x333);
	lv_img_set_pivot(ui->scrCopy2_imgScanned, 0,0);
	lv_img_set_angle(ui->scrCopy2_imgScanned, 0);
	lv_obj_set_pos(ui->scrCopy2_imgScanned, 51, 132);
	lv_obj_set_size(ui->scrCopy2_imgScanned, 514, 333);
	...
	lv_obj_set_pos(ui->scrCopy2_btnNext, 622, 483);
	lv_obj_set_size(ui->scrCopy2_btnNext, 349, 83);
	...
	lv_obj_set_style_radius(ui->scrCopy2_btnNext, 41, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_btnNext, &lv_font_montserratMedium_38, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_contPanel, 622, 132);
	lv_obj_set_size(ui->scrCopy2_contPanel, 349, 313);
	...
	lv_obj_set_style_radius(ui->scrCopy2_contPanel, 17, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_labelCopies, 68, 15);
	lv_obj_set_size(ui->scrCopy2_labelCopies, 213, 70);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_labelCopies, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_labelCounter, 102, 77);
	lv_obj_set_size(ui->scrCopy2_labelCounter, 136, 66);
	...
	lv_obj_set_style_radius(ui->scrCopy2_labelCounter, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->scrCopy2_labelCounter, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->scrCopy2_labelCounter, &lv_font_montserratMedium_53, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_btnPlus, 260, 77);
	lv_obj_set_size(ui->scrCopy2_btnPlus, 74, 66);
	...
	lv_obj_set_style_radius(ui->scrCopy2_btnPlus, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_btnPlus, &lv_font_montserratMedium_53, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_btnMinus, 12, 77);
	lv_obj_set_size(ui->scrCopy2_btnMinus, 74, 66);
	...
	lv_obj_set_style_radius(ui->scrCopy2_btnMinus, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_btnMinus, &lv_font_montserratMedium_53, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_labelColor, 10, 185);
	lv_obj_set_size(ui->scrCopy2_labelColor, 132, 57);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_labelColor, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_labelVertical, 160, 187);
	lv_obj_set_size(ui->scrCopy2_labelVertical, 183, 57);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_labelVertical, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_swColor, 27, 244);
	lv_obj_set_size(ui->scrCopy2_swColor, 93, 48);
	...
	lv_obj_set_style_radius(ui->scrCopy2_swColor, 24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy2_swColor, 220, LV_PART_KNOB|LV_STATE_DEFAULT);

	//Write codes scrCopy2_swVertical
	ui->scrCopy2_swVertical = lv_switch_create(ui->scrCopy2_contPanel);
	lv_obj_set_pos(ui->scrCopy2_swVertical, 209, 244);
	lv_obj_set_size(ui->scrCopy2_swVertical, 93, 48);
	...
	lv_obj_set_style_radius(ui->scrCopy2_swVertical, 24, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy2_swVertical, 220, LV_PART_KNOB|LV_STATE_DEFAULT);

	//Write codes scrCopy2_contDDLpanel
	ui->scrCopy2_contDDLpanel = lv_obj_create(ui->scrCopy2);
	lv_obj_set_pos(ui->scrCopy2_contDDLpanel, 51, 483);
	lv_obj_set_size(ui->scrCopy2_contDDLpanel, 514, 99);
	...
	lv_obj_set_style_radius(ui->scrCopy2_contDDLpanel, 17, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy2_ddlistMode, 17, 19);
	lv_obj_set_size(ui->scrCopy2_ddlistMode, 230, 66);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistMode, &lv_font_montserratMedium_29, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistMode, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistMode, &lv_font_montserratMedium_29, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistMode, 6, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistMode, &lv_font_montserratMedium_29, LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistMode, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistMode, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistMode, 6, LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_style_set_text_font(&style_scrCopy2_ddlistMode_extra_list_main_default, &lv_font_montserratMedium_29);
	...
	lv_style_set_radius(&style_scrCopy2_ddlistMode_extra_list_scrollbar_default, 6);
	...
	lv_obj_set_pos(ui->scrCopy2_ddlistDPI, 266, 19);
	lv_obj_set_size(ui->scrCopy2_ddlistDPI, 230, 66);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistDPI, &lv_font_montserratMedium_29, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistDPI, 8, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistDPI, &lv_font_montserratMedium_29, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistDPI, 6, LV_PART_MAIN|LV_STATE_CHECKED);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistDPI, &lv_font_montserratMedium_29, LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistDPI, 6, LV_PART_MAIN|LV_STATE_FOCUSED);
	...
	lv_obj_set_style_text_font(ui->scrCopy2_ddlistDPI, &lv_font_montserratMedium_25, LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_obj_set_style_radius(ui->scrCopy2_ddlistDPI, 6, LV_PART_MAIN|LV_STATE_DISABLED);
	...
	lv_style_set_text_font(&style_scrCopy2_ddlistDPI_extra_list_main_default, &lv_font_montserratMedium_29);
	...
	lv_style_set_radius(&style_scrCopy2_ddlistDPI_extra_list_scrollbar_default, 6);
