...
void setup_scr_scrPrintFini(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrPrintFini, 1024, 600);
	...
	lv_obj_set_size(ui->scrPrintFini_contBG, 1024, 600);
	...
	lv_obj_set_pos(ui->scrPrintFini_btnNxet, 345, 465);
	lv_obj_set_size(ui->scrPrintFini_btnNxet, 332, 86);
	...
	lv_obj_set_style_radius(ui->scrPrintFini_btnNxet, 41, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrPrintFini_btnNxet, &lv_font_montserratMedium_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrPrintFini_imgIconOk, &_ready_alpha_234x234);
	lv_img_set_pivot(ui->scrPrintFini_imgIconOk, 55,55);
	lv_img_set_angle(ui->scrPrintFini_imgIconOk, 0);
	lv_obj_set_pos(ui->scrPrintFini_imgIconOk, 394, 79);
	lv_obj_set_size(ui->scrPrintFini_imgIconOk, 234, 234);
	...
	lv_obj_set_pos(ui->scrPrintFini_labelPrompt, 155, 370);
	lv_obj_set_size(ui->scrPrintFini_labelPrompt, 714, 70);
	...
	lv_obj_set_style_text_font(ui->scrPrintFini_labelPrompt, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
