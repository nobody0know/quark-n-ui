...
void setup_scr_scrSetup(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrSetup, 1024, 600);
	...
	lv_obj_set_size(ui->scrSetup_contBG, 1024, 600);
	...
	lv_img_set_src(ui->scrSetup_imgPrinter, &_printer2_alpha_179x172);
	lv_img_set_pivot(ui->scrSetup_imgPrinter, 55,55);
	lv_img_set_angle(ui->scrSetup_imgPrinter, 0);
	lv_obj_set_pos(ui->scrSetup_imgPrinter, 264, 172);
	lv_obj_set_size(ui->scrSetup_imgPrinter, 179, 172);
	...
	lv_img_set_src(ui->scrSetup_imgWave, &_no_internet_alpha_85x81);
	lv_img_set_pivot(ui->scrSetup_imgWave, 50,50);
	lv_img_set_angle(ui->scrSetup_imgWave, 0);
	lv_obj_set_pos(ui->scrSetup_imgWave, 471, 150);
	lv_obj_set_size(ui->scrSetup_imgWave, 85, 81);
	...
	lv_img_set_src(ui->scrSetup_imgCloud, &_cloud_alpha_157x112);
	lv_img_set_pivot(ui->scrSetup_imgCloud, 50,50);
	lv_img_set_angle(ui->scrSetup_imgCloud, 0);
	lv_obj_set_pos(ui->scrSetup_imgCloud, 590, 81);
	lv_obj_set_size(ui->scrSetup_imgCloud, 157, 112);
	...
	lv_obj_set_pos(ui->scrSetup_labelPrompt, 64, 403);
	lv_obj_set_size(ui->scrSetup_labelPrompt, 896, 70);
	...
	lv_obj_set_style_text_font(ui->scrSetup_labelPrompt, &lv_font_montserratMedium_34, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrSetup_btnBack, 384, 472);
	lv_obj_set_size(ui->scrSetup_btnBack, 256, 86);
	...
	lv_obj_set_style_radius(ui->scrSetup_btnBack, 41, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrSetup_btnBack, &lv_font_montserratMedium_34, LV_PART_MAIN|LV_STATE_DEFAULT);
