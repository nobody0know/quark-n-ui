...
void setup_scr_scrScan(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrScan, 1024, 600);
	...
	lv_obj_set_size(ui->scrScan_contBG, 1024, 132);
	...
	lv_obj_set_pos(ui->scrScan_labelTitle, 288, 50);
	lv_obj_set_size(ui->scrScan_labelTitle, 448, 70);
	...
	lv_obj_set_style_text_font(ui->scrScan_labelTitle, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrScan_imgScanned, &_example_alpha_661x427);
	lv_img_set_pivot(ui->scrScan_imgScanned, 0,0);
	lv_img_set_angle(ui->scrScan_imgScanned, 0);
	lv_obj_set_pos(ui->scrScan_imgScanned, 51, 132);
	lv_obj_set_size(ui->scrScan_imgScanned, 661, 427);
	...
	lv_obj_set_pos(ui->scrScan_contPanel, 759, 132);
	lv_obj_set_size(ui->scrScan_contPanel, 213, 319);
	...
	lv_obj_set_style_radius(ui->scrScan_contPanel, 17, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrScan_imgIconBright, &_bright_alpha_42x42);
	lv_img_set_pivot(ui->scrScan_imgIconBright, 50,50);
	lv_img_set_angle(ui->scrScan_imgIconBright, 0);
	lv_obj_set_pos(ui->scrScan_imgIconBright, 38, 19);
	lv_obj_set_size(ui->scrScan_imgIconBright, 42, 42);
	...
	lv_img_set_src(ui->scrScan_imgIconHue, &_hue_alpha_38x38);
	lv_img_set_pivot(ui->scrScan_imgIconHue, 50,50);
	lv_img_set_angle(ui->scrScan_imgIconHue, 0);
	lv_obj_set_pos(ui->scrScan_imgIconHue, 130, 22);
	lv_obj_set_size(ui->scrScan_imgIconHue, 38, 38);
	...
	lv_obj_set_pos(ui->scrScan_sliderBright, 55, 83);
	lv_obj_set_size(ui->scrScan_sliderBright, 10, 209);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderBright, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderBright, 110, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderBright, 110, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScan_sliderHue, 145, 83);
	lv_obj_set_size(ui->scrScan_sliderHue, 10, 209);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderHue, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderHue, 110, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrScan_sliderHue, 110, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScan_btnNext, 759, 491);
	lv_obj_set_size(ui->scrScan_btnNext, 213, 81);
	...
	lv_obj_set_style_radius(ui->scrScan_btnNext, 37, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrScan_btnNext, &lv_font_montserratMedium_38, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScan_btnBack, 53, 37);
	lv_obj_set_size(ui->scrScan_btnBack, 74, 70);
	...
	lv_obj_set_style_radius(ui->scrScan_btnBack, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrScan_btnBack, &lv_font_montserratMedium_53, LV_PART_MAIN|LV_STATE_DEFAULT);
