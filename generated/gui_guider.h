...
LV_IMG_DECLARE(_btn_bg_4_213x264);
LV_IMG_DECLARE(_setup_alpha_85x85);

LV_IMG_DECLARE(_btn_bg_3_213x264);
LV_IMG_DECLARE(_print_alpha_85x85);

LV_IMG_DECLARE(_btn_bg_1_213x264);
LV_IMG_DECLARE(_copy_alpha_78x88);

LV_IMG_DECLARE(_btn_bg_2_213x264);
LV_IMG_DECLARE(_scan_alpha_78x88);
LV_IMG_DECLARE(_wifi_alpha_70x55);
LV_IMG_DECLARE(_tel_alpha_59x52);
LV_IMG_DECLARE(_eco_alpha_61x48);
LV_IMG_DECLARE(_pc_alpha_64x52);
LV_IMG_DECLARE(_example_alpha_661x427);
LV_IMG_DECLARE(_bright_alpha_42x42);
LV_IMG_DECLARE(_hue_alpha_38x38);
LV_IMG_DECLARE(_example_alpha_514x333);
LV_IMG_DECLARE(_example_alpha_661x427);
LV_IMG_DECLARE(_bright_alpha_42x42);
LV_IMG_DECLARE(_hue_alpha_38x38);

LV_IMG_DECLARE(_btn_bg_4_213x264);
LV_IMG_DECLARE(_internet_alpha_85x85);

LV_IMG_DECLARE(_btn_bg_3_213x264);
LV_IMG_DECLARE(_mobile_alpha_74x88);

LV_IMG_DECLARE(_btn_bg_2_213x264);
LV_IMG_DECLARE(_usb_alpha_87x88);
LV_IMG_DECLARE(_printer2_alpha_185x187);
LV_IMG_DECLARE(_wave_alpha_44x72);
LV_IMG_DECLARE(_phone_alpha_117x154);
LV_IMG_DECLARE(_printer2_alpha_179x172);
LV_IMG_DECLARE(_no_internet_alpha_85x81);
LV_IMG_DECLARE(_cloud_alpha_157x112);
LV_IMG_DECLARE(_printer2_alpha_179x172);
LV_IMG_DECLARE(_no_internet_alpha_85x81);
LV_IMG_DECLARE(_cloud_alpha_157x112);
LV_IMG_DECLARE(_ready_alpha_234x234);
LV_IMG_DECLARE(_ready_alpha_234x234);
