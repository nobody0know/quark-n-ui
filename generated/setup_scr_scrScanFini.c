...
void setup_scr_scrScanFini(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrScanFini, 1024, 600);
	...
	lv_obj_set_size(ui->scrScanFini_contBG, 1024, 600);
	...
	lv_img_set_src(ui->scrScanFini_imgIconOk, &_ready_alpha_234x234);
	lv_img_set_pivot(ui->scrScanFini_imgIconOk, 55,55);
	lv_img_set_angle(ui->scrScanFini_imgIconOk, 0);
	lv_obj_set_pos(ui->scrScanFini_imgIconOk, 394, 79);
	lv_obj_set_size(ui->scrScanFini_imgIconOk, 234, 234);
	...
	lv_obj_set_pos(ui->scrScanFini_labelPrompt, 155, 370);
	lv_obj_set_size(ui->scrScanFini_labelPrompt, 714, 70);
	...
	lv_obj_set_style_text_font(ui->scrScanFini_labelPrompt, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrScanFini_btnNxet, 345, 465);
	lv_obj_set_size(ui->scrScanFini_btnNxet, 332, 86);
	...
	lv_obj_set_style_radius(ui->scrScanFini_btnNxet, 41, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrScanFini_btnNxet, &lv_font_montserratMedium_34, LV_PART_MAIN|LV_STATE_DEFAULT);
