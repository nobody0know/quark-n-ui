...
void setup_scr_scrCopy(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrCopy, 1024, 600);
	...
	lv_obj_set_size(ui->scrCopy_contBG, 1024, 132);
	...
	lv_obj_set_pos(ui->scrCopy_labelTitle, 288, 50);
	lv_obj_set_size(ui->scrCopy_labelTitle, 448, 70);
	...
	lv_obj_set_style_text_font(ui->scrCopy_labelTitle, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrCopy_imgScanned, &_example_alpha_661x427);
	lv_img_set_pivot(ui->scrCopy_imgScanned, 0,0);
	lv_img_set_angle(ui->scrCopy_imgScanned, 0);
	lv_obj_set_pos(ui->scrCopy_imgScanned, 51, 132);
	lv_obj_set_size(ui->scrCopy_imgScanned, 661, 427);
	...
	lv_obj_set_pos(ui->scrCopy_contPanel, 759, 132);
	lv_obj_set_size(ui->scrCopy_contPanel, 213, 319);
	...
	lv_obj_set_style_radius(ui->scrCopy_contPanel, 17, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_img_set_src(ui->scrCopy_imgBright, &_bright_alpha_42x42);
	lv_img_set_pivot(ui->scrCopy_imgBright, 50,50);
	lv_img_set_angle(ui->scrCopy_imgBright, 0);
	lv_obj_set_pos(ui->scrCopy_imgBright, 38, 19);
	lv_obj_set_size(ui->scrCopy_imgBright, 42, 42);
	...
	lv_img_set_src(ui->scrCopy_imgColor, &_hue_alpha_38x38);
	lv_img_set_pivot(ui->scrCopy_imgColor, 50,50);
	lv_img_set_angle(ui->scrCopy_imgColor, 0);
	lv_obj_set_pos(ui->scrCopy_imgColor, 130, 22);
	lv_obj_set_size(ui->scrCopy_imgColor, 38, 38);
	...
	lv_obj_set_pos(ui->scrCopy_sliderBright, 55, 83);
	lv_obj_set_size(ui->scrCopy_sliderBright, 10, 209);
	...
	lv_obj_set_style_radius(ui->scrCopy_sliderBright, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy_sliderBright, 110, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy_sliderBright, 110, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy_sliderHue, 145, 83);
	lv_obj_set_size(ui->scrCopy_sliderHue, 10, 209);
	...
	lv_obj_set_style_radius(ui->scrCopy_sliderHue, 110, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy_sliderHue, 110, LV_PART_INDICATOR|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_radius(ui->scrCopy_sliderHue, 110, LV_PART_KNOB|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy_btnNext, 759, 491);
	lv_obj_set_size(ui->scrCopy_btnNext, 213, 81);
	...
	lv_obj_set_style_radius(ui->scrCopy_btnNext, 37, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy_btnNext, &lv_font_montserratMedium_38, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrCopy_btnBack, 53, 37);
	lv_obj_set_size(ui->scrCopy_btnBack, 74, 70);
	...
	lv_obj_set_style_radius(ui->scrCopy_btnBack, 11, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrCopy_btnBack, &lv_font_montserratMedium_53, LV_PART_MAIN|LV_STATE_DEFAULT);
