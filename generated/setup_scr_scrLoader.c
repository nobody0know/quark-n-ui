...
void setup_scr_scrLoader(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrLoader, 1024, 600);
	...
	lv_obj_set_size(ui->scrLoader_contBG, 1024, 600);
	...
	lv_obj_set_pos(ui->scrLoader_arcLoader, 362, 123);
	lv_obj_set_size(ui->scrLoader_arcLoader, 298, 298);
	...
	lv_obj_set_style_radius(ui->scrLoader_arcLoader, 13, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	// lv_obj_set_pos(ui->scrLoader_tpLoader, 405, 242);
	// lv_obj_set_size(ui->scrLoader_tpLoader, 213, 70);
	...
	lv_obj_set_style_text_font(ui->scrLoader_tpLoader, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrLoader_labelPrompt, 155, 505);
	lv_obj_set_size(ui->scrLoader_labelPrompt, 714, 70);
	...
	lv_obj_set_style_text_font(ui->scrLoader_labelPrompt, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
