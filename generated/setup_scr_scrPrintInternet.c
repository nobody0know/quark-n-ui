...
void setup_scr_scrPrintInternet(lv_ui *ui)
{
	...
	lv_obj_set_size(ui->scrPrintInternet, 1024, 600);
	...
	lv_obj_set_size(ui->scrPrintInternet_contBG, 1024, 600);
	...
	lv_img_set_src(ui->scrPrintInternet_imgPrinter, &_printer2_alpha_179x172);
	lv_img_set_pivot(ui->scrPrintInternet_imgPrinter, 55,55);
	lv_img_set_angle(ui->scrPrintInternet_imgPrinter, 0);
	lv_obj_set_pos(ui->scrPrintInternet_imgPrinter, 264, 172);
	lv_obj_set_size(ui->scrPrintInternet_imgPrinter, 179, 172);
	...
	lv_img_set_src(ui->scrPrintInternet_imgWave, &_no_internet_alpha_85x81);
	lv_img_set_pivot(ui->scrPrintInternet_imgWave, 50,50);
	lv_img_set_angle(ui->scrPrintInternet_imgWave, 0);
	lv_obj_set_pos(ui->scrPrintInternet_imgWave, 471, 150);
	lv_obj_set_size(ui->scrPrintInternet_imgWave, 85, 81);
	...
	lv_img_set_src(ui->scrPrintInternet_imgCloud, &_cloud_alpha_157x112);
	lv_img_set_pivot(ui->scrPrintInternet_imgCloud, 50,50);
	lv_img_set_angle(ui->scrPrintInternet_imgCloud, 0);
	lv_obj_set_pos(ui->scrPrintInternet_imgCloud, 590, 81);
	lv_obj_set_size(ui->scrPrintInternet_imgCloud, 157, 112);
	...
	lv_obj_set_pos(ui->scrPrintInternet_labelPrompt, 115, 383);
	lv_obj_set_size(ui->scrPrintInternet_labelPrompt, 793, 70);
	...
	lv_obj_set_style_text_font(ui->scrPrintInternet_labelPrompt, &lv_font_montserratMedium_42, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->scrPrintInternet_btnBack, 384, 472);
	lv_obj_set_size(ui->scrPrintInternet_btnBack, 256, 86);
	...
	lv_obj_set_style_radius(ui->scrPrintInternet_btnBack, 41, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_text_font(ui->scrPrintInternet_btnBack, &lv_font_montserratMedium_34, LV_PART_MAIN|LV_STATE_DEFAULT);
